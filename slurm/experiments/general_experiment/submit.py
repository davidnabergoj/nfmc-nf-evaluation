...
from slurm.constants import ROOT_DIR, TARGETS_NON_IMAGE
from slurm.util import print_submit_countdown, get_strategies_all
...
if __name__ == '__main__':
    ...
    # Main variables
    device = 'cpu'
    reserved_time_minutes = int(args.sampling_time_limit_seconds // 60 + args.warmup_time_limit_seconds // 60 + 60)
    name_prefix = 'gen-'
    experiment_dir = f'{ROOT_DIR}/slurm/experiments/general_experiment'
