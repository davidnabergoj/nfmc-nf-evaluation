...
if __name__ == '__main__':
    ...
    name_prefix = 'crv-'
    experiment_dir = f'{ROOT_DIR}/slurm/experiments/curvature_strength_ablation'
    ...
    configs = make_configs_product(
        {
            'curvature_strength': [0.01, 0.1, 1, 10, 100],
            'strategy': get_strategies_single_config(),
            'benchmark': ['funnel'],  # skip rosenbrock until we have analytic ground truth moments
        },
